...
1. **Tangle shared infrastructure** — `docker/docker-compose.yml`, `toxiproxy/config.json`
   - Acceptance: `docker compose -f docker/docker-compose.yml config` validates without error
